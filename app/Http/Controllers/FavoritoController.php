...
class FavoritoController extends Controller
{
    ...
    public function fav(Request $request)
    {
        ...
        foreach($favoritos as $fav){
            if($fav->id_usuario==$request['id_usuario'] && $fav->id_receta==$request['id_receta']){
                return redirect()->route('inicio')
                ->with('success', 'Esta receta ya está en favoritos');
            }
        }
        ...
        return redirect()->route('inicio')
            ->with('success', 'Receta añadida a favoritos');
    }
